classdef SANTIA_toolbox < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        CreateNetworkButton_2           matlab.ui.control.Button
        ChooseNetworkDropDown_4         matlab.ui.control.DropDown
        ChooseNetworkDropDown_4Label    matlab.ui.control.Label
...
%         end
        ...
        value = str2num(app.ChooseNetworkDropDown_4.Value);
        ...
        if value ==1 || value ==3%%%%%%CNNLSTM TRAINING
        Y_t=Y_t';
        Y_v=Y_v';
        Y_e=Y_e';
        ...
        temp=cell2mat(data);
        newdata= [temp(pred_start:end,:);YPred'];
        data=num2cell(newdata,1);    
        end
        Y_e =Y_e';
        data=cell2mat(data);
        test_nn_output=data((end-test_seq_len+1):end,:);
        ...
        elseif value ==1 || value ==3%%%%%%CNNLSTM TRAINING        for j=1:labelrows
            for j=1:labelrows
                for k= (nn_input_w_numb+1):labelcols
                    if threshold_per_bin_per_ch(j,k)==1
                            data=labelled_signals(j, ((k-1-nn_input_w_numb)*window_datapoints+1 : (k-1)*window_datapoints))';
                            ...
                            YPred = predict(net,data);
                            temp=cell2mat(data);
                            newdata= [temp(nn_output+1:end,:);YPred'];
                            data=num2cell(newdata,1);     
                            end
                        data=cell2mat(data);   
                        labelled_signals(j, ((k-1)*window_datapoints+1 : k*window_datapoints))=data(end-window_datapoints+1:end)';
        ...
        % Button pushed function: CreateNetworkButton_2
        function CreateNetworkButton_2Pushed(app, event)
         Normal_seg_TrainingInput=getappdata(0,'normal_segments_struct');
        %%%FAILSAFE #1
        ...
        if r2~=0
            errordlg('DataforModelTesting must be multiple of the NNoutput','Error');             
            return
        end
        %%%%%%%%%%%%%%%%%%%%%%CREATE NETWORK
        if app.DatapointsButton.Value == true
        ...
        value = str2num(app.ChooseNetworkDropDown_4.Value);
        if value==1
            numFeatures =inputSize;% it depends on the roll back window (No of features, one output)
       ...
       app.Label_5.Text='Network Created';    
       setappdata(0,'layers',layers)
        end

        % Value changed function: ChooseNetworkDropDown_4
        function ChooseNetworkDropDown_4ValueChanged(app, event)
            value = app.ChooseNetworkDropDown_4.Value;           
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SaveResultsButton_2.Position = [398 6 123 60];
            ...
            app.TabGroup2_2.Position = [3 0 275 473];
            ...
            app.PlotCheckBox_2.Position = [26 134 43 22];
            ...
            app.ExecutionEnviromentDropDown_2Label.Position = [26 181 122 22];
            ...
            app.ExecutionEnviromentDropDown_2.Position = [156 181 92 22];
            ...
            app.SolverDropDown_2Label.Position = [26 417 40 22];
            ...
            app.SolverDropDown_2.Position = [81 417 100 22];
            ...
            app.InitialLearnRateSpinner_2Label.Position = [26 369 90 22];
            ...
            app.InitialLearnRateSpinner_2.Position = [143 369 105 22];
            ...
            app.ValidationFrequencySpinner_2Label.Position = [26 322 117 22];
            ...
            app.ValidationFrequencySpinner_2.Position = [162 322 88 22];
            ...
            app.MaxEpochsSpinner_2.Position = [133 275 119 22];
            ...
            app.MiniBatchSizeSpinner_2Label.Position = [26 228 82 22];
            ...
            app.MiniBatchSizeSpinner_2.Position = [129 228 123 22];
            ...
            app.VerboseCheckBox_2.Position = [26 87 66 22];
            ...
            app.VerboseFrequencySpinner_2Label.Position = [24 40 110 22];
            ...
            app.VerboseFrequencySpinner_2.Position = [142 40 109 22];
            ...
            app.L2RegularizationSpinner_2Label.Position = [8 404 96 22];
            ...
            app.L2RegularizationSpinner_2.Position = [124 404 103 22];
            ...
            app.GradientThresholdMethodDropDown_2Label.Position = [13 362 145 22];
            ...
            app.GradientThresholdMethodDropDown_2.Position = [168 362 71 22];
            ...
            app.ResetInputNormalizationCheckBox_2.Position = [13 59 124 22];
            ...
            app.GradientThresholdSpinner_2Label.Position = [13 320 105 22];
            ...
            app.GradientThresholdSpinner_2.Position = [128 320 90 22];
            ...
            app.ValidationPatienceSpinner_2Label.Position = [16 277 104 22];
            ...
            app.ValidationPatienceSpinner_2.Position = [129 278 94 22];
            ...
            app.ShuffleDropDown_2Label.Position = [13 234 43 22];
            ...
            app.ShuffleDropDown_2.Position = [79 235 71 22];
            ...
            app.LearnRateScheduleDropDown_2Label.Position = [13 189 112 22];
            ...
            app.LearnRateScheduleDropDown_2.Position = [143 192 71 22];
            ...
            app.LearnRateDropFactorSpinner_2Label.Position = [13 144 122 22];
            ...
            app.LearnRateDropFactorSpinner_2.Position = [146 148 81 22];
            ...
            app.LearnRateDropPeriodSpinner_2Label.Position = [13 103 122 22];
            ...
            app.LearnRateDropPeriodSpinner_2.Position = [146 100 82 22];
            ...
            app.MomentumSpinner_2Label.Position = [13 18 66 22];
            ...
            app.MomentumSpinner_2.Position = [94 18 124 22];
            ...
            app.NetworkTrainingPanel_2.Position = [12 6 302 521];
            ...
            app.TrainNetworkButton_2.Position = [89 138 139 35];
            ...
            app.ViewTestResultsButton.Position = [32 75 114 50];
            ...
            app.TrainingEditField_2Label.Position = [40 322 48 22];
            ...
            app.TrainingEditField_2.Position = [40 290 48 22];
            ...
            app.ValidationEditField_2Label.Position = [123 322 57 22];
            ...
            app.ValidationEditField_2.Position = [126 290 51 22];
            ...
            app.TestEditField_2Label.Position = [217 322 28 22];
            ...
            app.TestEditField_2.Position = [210 291 52 22];
            ...
            app.ReplaceSegmentsButton.Position = [176 75 117 50];
            ...
            app.PlotchannelButton.Position = [176 3 115 55];
            ...
            app.SequenceLengthPanel.Position = [2 359 299 139];
            ...
            app.NNInputEditFieldLabel.Position = [20 88 53 22];
            ...
            app.NNInputEditField.Position = [22 56 48 22];
            ...
            app.NNOutputEditFieldLabel.Position = [91 88 62 22];
            ...
            app.NNOutputEditField.Position = [98 56 48 22];
            ...
            app.DatapointsButton.Position = [152 3 79 22];
            ...
            app.DataforModelTestingLabel.Position = [167 88 125 22];
            ...
            app.DataforModelTestingEditField.Position = [201 56 48 22];
            app.DataforModelTestingEditField.Value = 100;

            % Create ChooseNetworkDropDown_4Label
            app.ChooseNetworkDropDown_4Label = uilabel(app.NetworkTrainingPanel_2);
            app.ChooseNetworkDropDown_4Label.HorizontalAlignment = 'right';
            app.ChooseNetworkDropDown_4Label.Position = [107 255 94 22];
            app.ChooseNetworkDropDown_4Label.Text = 'Choose Network';

            % Create ChooseNetworkDropDown_4
            app.ChooseNetworkDropDown_4 = uidropdown(app.NetworkTrainingPanel_2);
            app.ChooseNetworkDropDown_4.Items = {'CNN-LSTM (prebuilt)', 'LSTM(prebuilt)', 'Load Custom'};
            app.ChooseNetworkDropDown_4.ItemsData = {'1', '2', '3'};
            app.ChooseNetworkDropDown_4.ValueChangedFcn = createCallbackFcn(app, @ChooseNetworkDropDown_4ValueChanged, true);
            app.ChooseNetworkDropDown_4.Tooltip = {'Choose a neural network model.'};
            app.ChooseNetworkDropDown_4.Position = [46 229 216 22];
            app.ChooseNetworkDropDown_4.Value = '1';

            % Create CreateNetworkButton_2
            app.CreateNetworkButton_2 = uibutton(app.NetworkTrainingPanel_2, 'push');
            app.CreateNetworkButton_2.ButtonPushedFcn = createCallbackFcn(app, @CreateNetworkButton_2Pushed, true);
            app.CreateNetworkButton_2.Tooltip = {'Adjust network to input size.'};
            app.CreateNetworkButton_2.Position = [107 184 109 31];
            app.CreateNetworkButton_2.Text = 'Create Network';

            % Create SelectChannelDropDown_2Label
            app.SelectChannelDropDown_2Label = uilabel(app.NetworkTrainingPanel_2);
            app.SelectChannelDropDown_2Label.HorizontalAlignment = 'right';
            app.SelectChannelDropDown_2Label.Position = [41 42 87 22];
            app.SelectChannelDropDown_2Label.Text = 'Select Channel';

            % Create SelectChannelDropDown_2
            app.SelectChannelDropDown_2 = uidropdown(app.NetworkTrainingPanel_2);
            app.SelectChannelDropDown_2.Items = {'Channel 1'};
            app.SelectChannelDropDown_2.Tooltip = {'Choose channel to plot.'};
            app.SelectChannelDropDown_2.Position = [35 9 100 22];
            ...
            app.TrainingDataPanel_3.Position = [14 535 299 131];
            ...
            app.LoadTrainingDataButton_2.Position = [96 62 120 45];
            ...
            app.ExtractArtifactfreeSegmentsButton.Position = [149 2 137 52];
            ...
            app.SegmentLengthmSEditFieldLabel.Position = [5 34 123 22];
            ...
            app.SegmentLengthmSEditField.Position = [42 2 48 22];

...
par.min_clus = 130;                  % minimum size of a cluster
...
par.sr=20000;%sr;%20000;                    % sampling rate % in case of transistor slice recording 20000
...
par.stdmin = 2.5;                    % minimum threshold for detection
par.stdmax = 30;                     % maximum threshold for detection 
par.detect_fmin = 100;               %high pass filter for detection % in case of transistor slice recording 100 Hz
par.detect_fmax = 8000;              %low pass filter for detection % in case of transistor slice recording 1000 Hz
par.sort_fmin = 100;                 %high pass filter for sorting % in case of transistor slice recording 100 Hz
par.sort_fmax = 8000;                %low pass filter for sorting % in case of transistor slice recording 1000 Hz

function[variance] = funz_variance_calc(mat_appartenenze, mat_coordinate_clu, mat_coordinate_sgn)
...
for a = 1:nr_cl
    ...
    for b = 1:length(pos)
        ...
        sommation = sommation + funz_Euclidian_distance(coord_tmp_sgn,coord_tmp_clu);        
    end

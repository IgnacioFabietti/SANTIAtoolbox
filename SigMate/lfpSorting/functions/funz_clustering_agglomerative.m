function[cluster_mat, cluster_vet_stop, vect_distance, K, mat_dendrogram] = funz_clustering_agglomerative(mat_data)
...
mat_distance = funz_calcolo_mat_dist_new(mat_data, measure);
...
for i = 2:nr   
    [mat_distance_new, cluster_vet_new, dist_select, vet_dendrogram, vet_dendro_sup_new] = funz_aggiornamento_mat_dist(mat_distance, cluster_vet, rule, vet_dendro_sup);

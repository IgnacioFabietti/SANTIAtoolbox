function[mat_dist_new, cluster_vet_new, dist_select, vet_dendrogram, vet_dendro_sup_new] = updateDistanceMatrix(mat_distance, cluster_vet, rule, vet_dendro_sup)
...
val_vett = calculateNonZeroElementsOfMatrix(mat_distance);

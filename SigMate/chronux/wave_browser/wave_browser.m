...
% FIGWAVEBROWSER M-file for figWaveBrowser.fig
%      FIGWAVEBROWSER, by itself, creates a new FIGWAVEBROWSER or raises the existing
%      singleton*.
%
%      H = FIGWAVEBROWSER returns the handle to a new FIGWAVEBROWSER or the handle to
%      the existing singleton*.
%
%      FIGWAVEBROWSER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FIGWAVEBROWSER.M with the given input arguments.
%
%      FIGWAVEBROWSER('Property','Value',...) creates a new FIGWAVEBROWSER or raises the
...
% Edit the above text to modify the response to help figWaveBrowser

% Last Modified by GUIDE v2.5 11-May-2012 18:10:38
...
% --- Executes just before figWaveBrowser is made visible.
function wave_browser_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to figWaveBrowser (see VARARGIN)
...
fh = findobj('Tag', 'figWaveBrowser');
setappdata(fh, 'addedPath',toks);

% Choose default command line output for figWaveBrowser
...
% UIWAIT makes figWaveBrowser wait for user response (see UIRESUME)
% uiwait(handles.figWaveBrowser);
...
handles.datacursor=datacursormode(handles.figWaveBrowser);  
axes(handles.axesP);
...
% --- Executes on button press in btnchronuxClose.
function btnchronuxClose_Callback(hObject, eventdata, handles)
% hObject    handle to btnchronuxClose (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on key press with focus on figWaveBrowser and none of its controls.
function figWaveBrowser_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to figWaveBrowser (see GCBO)

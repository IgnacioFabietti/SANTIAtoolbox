function [filteredPotentialsForCSD, t]= filterSignalsForCSDV2(filePath, fileNames, checkedColumns, stimOnset)
...
%     potFilt=zeros(r-preStimDataPoints,c);
    preStimPart = zeros(preStimDataPoints, 1);
...
%         [B,A] = butter(3,Wc);
        ...
        tempS=[preStimPart; filteredPotentials(preStimDataPoints+1:r,i)];
        potFilt(:,i) = tempS;

    end 

    filteredPotentialsForCSD = potFilt;
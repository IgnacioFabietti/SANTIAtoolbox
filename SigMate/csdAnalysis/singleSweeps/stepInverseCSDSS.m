function [sigma, sourceDiameter, csd, lfp, t]=stepInverseCSDSS(directoryPath, fileNames, recordingDepths, sigma, sourceDiameter, checkedColumns)
...
%     potentials=pot(:,2:c-1);

    z=recordingDepths/(10^6); % electrode spacing in meters

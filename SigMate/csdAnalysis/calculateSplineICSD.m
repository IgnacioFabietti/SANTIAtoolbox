function M=calculateSplineICSD(potentials,sigma,h,z,R)

% This is a function that calculates the CSD throught the spline iCSD method
...
% the radius the source of CSD
    ...
    E0=toeplitz(row);  % identity matrix
    E0=E0(1:N+1,:);

function[t_SS,v_SS,t_RS,v_RS,t_P1,v_P1,l_P1,t_P2,v_P2,l_P2,t_P3,v_P3,l_P3,t_P4,v_P4,l_P4,s,t,flag] =  detectLatencyInCSD(data, cutoffFreq, signalType)
    ...
    % 50 ms for the detection of the starting of response onset
    if (signalType==2) % if the traces are of micropipette recording
